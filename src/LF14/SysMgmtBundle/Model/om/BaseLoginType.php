...
abstract class BaseLoginType extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'LF14\\SysMgmtBundle\\Model\\LoginTypePeer';
    ...
    /**
     * Initializes internal state of BaseLoginType object.
     * @see        applyDefaults()
     */
     ...
     * @return LoginType The current object (for fluent API support)
     */
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[] = LoginTypePeer::ID;
        }
    ...
    public function setType($v)
    {
        ...
        if ($this->type !== $v) {
            $this->type = $v;
            $this->modifiedColumns[] = LoginTypePeer::TYPE;
        }
    ...
    public function setNotes($v)
    {
        ...
        if ($this->notes !== $v) {
            $this->notes = $v;
            $this->modifiedColumns[] = LoginTypePeer::NOTES;
        }
    ...
    public function setCreatedAt($v)
    {
        ...
        if ($this->created_at !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = LoginTypePeer::CREATED_AT;
            }
    ...
    public function setUpdatedAt($v)
    {
        ...
        if ($this->updated_at !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = LoginTypePeer::UPDATED_AT;
            }
        } // if either are not null
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            return $startcol + 5; // 5 = LoginTypePeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating LoginType object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = LoginTypePeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = LoginTypeQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                LoginTypePeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
        ...
        if (!$this->alreadyInSave) {
            ...
            if ($this->loginsScheduledForDeletion !== null) {
                if (!$this->loginsScheduledForDeletion->isEmpty()) {
                    foreach ($this->loginsScheduledForDeletion as $login) {
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(LoginTypePeer::ID)) {
            $modifiedColumns[':p' . $index++]  = '`id`';
        }
        if ($this->isColumnModified(LoginTypePeer::TYPE)) {
            $modifiedColumns[':p' . $index++]  = '`type`';
        }
        if ($this->isColumnModified(LoginTypePeer::NOTES)) {
            $modifiedColumns[':p' . $index++]  = '`notes`';
        }
        if ($this->isColumnModified(LoginTypePeer::CREATED_AT)) {
            $modifiedColumns[':p' . $index++]  = '`created_at`';
        }
        if ($this->isColumnModified(LoginTypePeer::UPDATED_AT)) {
            $modifiedColumns[':p' . $index++]  = '`updated_at`';
        }

        $sql = sprintf(
            'INSERT INTO `login_type` (%s) VALUES (%s)',
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = LoginTypePeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = LoginTypePeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['LoginType'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['LoginType'][$this->getPrimaryKey()] = true;
        $keys = LoginTypePeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
            $keys[1] => $this->getType(),
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(LoginTypePeer::ID)) $criteria->add(LoginTypePeer::ID, $this->id);
        if ($this->isColumnModified(LoginTypePeer::TYPE)) $criteria->add(LoginTypePeer::TYPE, $this->type);
        if ($this->isColumnModified(LoginTypePeer::NOTES)) $criteria->add(LoginTypePeer::NOTES, $this->notes);
        if ($this->isColumnModified(LoginTypePeer::CREATED_AT)) $criteria->add(LoginTypePeer::CREATED_AT, $this->created_at);
        if ($this->isColumnModified(LoginTypePeer::UPDATED_AT)) $criteria->add(LoginTypePeer::UPDATED_AT, $this->updated_at);
    ...
    {
        $criteria = new Criteria(LoginTypePeer::DATABASE_NAME);
        $criteria->add(LoginTypePeer::ID, $this->id);
     ...
     * objects.
     *
     * @param object $copyObj An object of LoginType (or compatible) type.
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return LoginType Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return LoginTypePeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new LoginTypePeer();
        }
     ...
     * If this LoginType is new, it will return
    ...
    public function setLogins(PropelCollection $logins, PropelPDO $con = null)
    {
        ...
        foreach ($loginsToDelete as $loginRemoved) {
            $loginRemoved->setLoginType(null);
        }
    ...
    public function removeLogin($login)
    {
        if ($this->getLogins()->contains($login)) {
            ...
            $this->loginsScheduledForDeletion[]= $login;
     ...
     * Otherwise if this LoginType is new, it will return
     * an empty collection; or if this LoginType has previously
     * been saved, it will retrieve related Logins from storage.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in LoginType.
     *
     * @param Criteria $criteria optional Criteria object to narrow the query
     * @param PropelPDO $con optional connection object
     ...
     * @return PropelObjectCollection|Login[] List of Login objects
     */
    public function getLoginsJoinHost($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        $query = LoginQuery::create(null, $criteria);
    ...
    {
        return (string) $this->exportTo(LoginTypePeer::DEFAULT_STRING_FORMAT);
    }
