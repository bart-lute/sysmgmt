...
use LF14\SysMgmtBundle\Model\map\ClientTableMap;
...
abstract class BaseClientPeer
{
    ...
    const OM_CLASS = 'LF14\\SysMgmtBundle\\Model\\Client';

    /** the related TableMap class for this table */
    const TM_CLASS = 'LF14\\SysMgmtBundle\\Model\\map\\ClientTableMap';
    ...
    protected static $fieldNames = array (
        ...
        BasePeer::TYPE_COLNAME => array (ClientPeer::ID, ClientPeer::NAME, ClientPeer::NOTES, ClientPeer::CREATED_AT, ClientPeer::UPDATED_AT, ),
    ...
    protected static $fieldKeys = array (
        ...
        BasePeer::TYPE_COLNAME => array (ClientPeer::ID => 0, ClientPeer::NAME => 1, ClientPeer::NOTES => 2, ClientPeer::CREATED_AT => 3, ClientPeer::UPDATED_AT => 4, ),
    ...
    public static function buildTableMap()
    {
      ...
      if (!$dbMap->hasTable(BaseClientPeer::TABLE_NAME)) {
        $dbMap->addTableObject(new \LF14\SysMgmtBundle\Model\map\ClientTableMap());
      }
    }
     ...
     */
     public static function doDelete($values, PropelPDO $con = null)
     {
        ...
        try {
            ...
            // cloning the Criteria in case it's modified by doSelect() or doSelectStmt()
            $c = clone $criteria;
            ClientPeer::doOnDeleteSetNull($c, $con);
    ...
    protected static function doOnDeleteCascade(Criteria $criteria, PropelPDO $con)
    {
        ...
        foreach ($objects as $obj) {
            ...
            $criteria->add(ClientContactPeer::CLIENT_ID, $obj->getId());
    ...
    protected static function doOnDeleteSetNull(Criteria $criteria, PropelPDO $con)
    {
        ...
        foreach ($objects as $obj) {
            ...
            $selectCriteria->add(DomainPeer::CLIENT_ID, $obj->getId());
            $updateValues->add(DomainPeer::CLIENT_ID, null);
            ...
            $selectCriteria = new Criteria(ClientPeer::DATABASE_NAME);
            $updateValues = new Criteria(ClientPeer::DATABASE_NAME);
            $selectCriteria->add(HostPeer::CLIENT_ID, $obj->getId());
            $updateValues->add(HostPeer::CLIENT_ID, null);
