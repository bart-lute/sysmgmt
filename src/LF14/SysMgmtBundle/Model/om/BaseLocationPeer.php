...
use LF14\SysMgmtBundle\Model\map\LocationTableMap;
...
abstract class BaseLocationPeer
{
    ...
    const OM_CLASS = 'LF14\\SysMgmtBundle\\Model\\Location';

    /** the related TableMap class for this table */
    const TM_CLASS = 'LF14\\SysMgmtBundle\\Model\\map\\LocationTableMap';
    ...
    const CONTACT_ID = 'location.contact_id';
    ...
    protected static $fieldNames = array (
        BasePeer::TYPE_PHPNAME => array ('Id', 'Name', 'Notes', 'ContactId', 'CreatedAt', 'UpdatedAt', ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'name', 'notes', 'contactId', 'createdAt', 'updatedAt', ),
        BasePeer::TYPE_COLNAME => array (LocationPeer::ID, LocationPeer::NAME, LocationPeer::NOTES, LocationPeer::CONTACT_ID, LocationPeer::CREATED_AT, LocationPeer::UPDATED_AT, ),
        BasePeer::TYPE_RAW_COLNAME => array ('ID', 'NAME', 'NOTES', 'CONTACT_ID', 'CREATED_AT', 'UPDATED_AT', ),
        BasePeer::TYPE_FIELDNAME => array ('id', 'name', 'notes', 'contact_id', 'created_at', 'updated_at', ),
    ...
    protected static $fieldKeys = array (
        BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'Name' => 1, 'Notes' => 2, 'ContactId' => 3, 'CreatedAt' => 4, 'UpdatedAt' => 5, ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'name' => 1, 'notes' => 2, 'contactId' => 3, 'createdAt' => 4, 'updatedAt' => 5, ),
        BasePeer::TYPE_COLNAME => array (LocationPeer::ID => 0, LocationPeer::NAME => 1, LocationPeer::NOTES => 2, LocationPeer::CONTACT_ID => 3, LocationPeer::CREATED_AT => 4, LocationPeer::UPDATED_AT => 5, ),
        BasePeer::TYPE_RAW_COLNAME => array ('ID' => 0, 'NAME' => 1, 'NOTES' => 2, 'CONTACT_ID' => 3, 'CREATED_AT' => 4, 'UPDATED_AT' => 5, ),
        BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'name' => 1, 'notes' => 2, 'contact_id' => 3, 'created_at' => 4, 'updated_at' => 5, ),
        BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, 5, )
    );
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(LocationPeer::NOTES);
            $criteria->addSelectColumn(LocationPeer::CONTACT_ID);
    ...
    public static function doCountJoinContact(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        $criteria->addJoin(LocationPeer::CONTACT_ID, ContactPeer::ID, $join_behavior);
    ...
    /**
     * Selects a collection of Location objects pre-filled with their Contact objects.
     * @param      Criteria  $criteria
     * @param      PropelPDO $con
     * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
    ...
    public static function doSelectJoinContact(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        LocationPeer::addSelectColumns($criteria);
        $startcol = LocationPeer::NUM_HYDRATE_COLUMNS;
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            $key1 = LocationPeer::getPrimaryKeyHashFromRow($row, 0);
            if (null !== ($obj1 = LocationPeer::getInstanceFromPool($key1))) {
                // We no longer rehydrate the object, since this can cause data loss.
                // See http://www.propelorm.org/ticket/509
                ...
                $obj1 = new $cls();
                $obj1->hydrate($row);
                LocationPeer::addInstanceToPool($obj1, $key1);
            ...
            if ($key2 !== null) {
                ...
                // Add the $obj1 (Location) to $obj2 (Contact)
    ...
    public static function doSelectJoinAll(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        LocationPeer::addSelectColumns($criteria);
        $startcol2 = LocationPeer::NUM_HYDRATE_COLUMNS;
        ...
        while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
            ...
            if ($key2 !== null) {
                ...
                // Add the $obj1 (Location) to the collection in $obj2 (Contact)
                $obj2->addLocation($obj1);
    ...
    public static function buildTableMap()
    {
      ...
      if (!$dbMap->hasTable(BaseLocationPeer::TABLE_NAME)) {
        $dbMap->addTableObject(new \LF14\SysMgmtBundle\Model\map\LocationTableMap());
      }
    }
    ...
    public static function doInsert($values, PropelPDO $con = null)
    {
        ...
        if ($criteria->containsKey(LocationPeer::ID) && $criteria->keyContainsValue(LocationPeer::ID) ) {
            throw new PropelException('Cannot insert a value for auto-increment primary key ('.LocationPeer::ID.')');
        }
    ...
    public static function doUpdate($values, PropelPDO $con = null)
    {
        ...
        if ($values instanceof Criteria) {
            ...
            $value = $criteria->remove(LocationPeer::ID);
            if ($value) {
                $selectCriteria->add(LocationPeer::ID, $value, $comparison);
            } else {
    ...
    public static function doDeleteAll(PropelPDO $con = null)
    {
        ...
        try {
            ...
            $con->beginTransaction();
            LocationPeer::doOnDeleteSetNull(new Criteria(LocationPeer::DATABASE_NAME), $con);
     ...
     */
     public static function doDelete($values, PropelPDO $con = null)
     {
        ...
        try {
            ...
            $c = clone $criteria;
            LocationPeer::doOnDeleteSetNull($c, $con);
    ...
    protected static function doOnDeleteSetNull(Criteria $criteria, PropelPDO $con)
    {
        ...
        $objects = LocationPeer::doSelect($criteria, $con);
        foreach ($objects as $obj) {

            // set fkey col in related Host rows to null
            $selectCriteria = new Criteria(LocationPeer::DATABASE_NAME);
            $updateValues = new Criteria(LocationPeer::DATABASE_NAME);
            $selectCriteria->add(HostPeer::LOCATION_ID, $obj->getId());
            $updateValues->add(HostPeer::LOCATION_ID, null);
