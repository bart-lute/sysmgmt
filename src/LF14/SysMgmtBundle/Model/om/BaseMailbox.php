...
abstract class BaseMailbox extends BaseObject implements Persistent
{
     ...
     * Peer class name
     */
    const PEER = 'LF14\\SysMgmtBundle\\Model\\MailboxPeer';
    ...
    /**
     * Initializes internal state of BaseMailbox object.
     * @see        applyDefaults()
     */
     ...
     * @return Mailbox The current object (for fluent API support)
     */
    ...
    public function setUsername($v)
    {
        ...
        if ($this->username !== $v) {
            $this->username = $v;
            $this->modifiedColumns[] = MailboxPeer::USERNAME;
        }
    ...
    public function setDateStart($v)
    {
        ...
        if ($this->date_start !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = MailboxPeer::DATE_START;
            }
    ...
    public function setDateEnd($v)
    {
        ...
        if ($this->date_end !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = MailboxPeer::DATE_END;
            }
        } // if either are not null
    ...
    public function setCreatedAt($v)
    {
        ...
        if ($this->created_at !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = MailboxPeer::CREATED_AT;
            }
        } // if either are not null
    ...
    public function setUpdatedAt($v)
    {
        ...
        if ($this->updated_at !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = MailboxPeer::UPDATED_AT;
            }
        } // if either are not null
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->domain_id = ($row[$startcol + 1] !== null) ? (int) $row[$startcol + 1] : null;
            $this->username = ($row[$startcol + 2] !== null) ? (string) $row[$startcol + 2] : null;
            $this->password = ($row[$startcol + 3] !== null) ? (string) $row[$startcol + 3] : null;
            $this->date_start = ($row[$startcol + 4] !== null) ? (string) $row[$startcol + 4] : null;
            $this->date_end = ($row[$startcol + 5] !== null) ? (string) $row[$startcol + 5] : null;
            ...
            return $startcol + 8; // 8 = MailboxPeer::NUM_HYDRATE_COLUMNS.
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = MailboxPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = MailboxQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                MailboxPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(MailboxPeer::ID)) {
            $modifiedColumns[':p' . $index++]  = '`id`';
        }
        if ($this->isColumnModified(MailboxPeer::DOMAIN_ID)) {
            $modifiedColumns[':p' . $index++]  = '`domain_id`';
        }
        if ($this->isColumnModified(MailboxPeer::USERNAME)) {
            $modifiedColumns[':p' . $index++]  = '`username`';
        }
        if ($this->isColumnModified(MailboxPeer::PASSWORD)) {
            $modifiedColumns[':p' . $index++]  = '`password`';
        }
        if ($this->isColumnModified(MailboxPeer::DATE_START)) {
            $modifiedColumns[':p' . $index++]  = '`date_start`';
        }
        if ($this->isColumnModified(MailboxPeer::DATE_END)) {
            $modifiedColumns[':p' . $index++]  = '`date_end`';
        }
        if ($this->isColumnModified(MailboxPeer::CREATED_AT)) {
            $modifiedColumns[':p' . $index++]  = '`created_at`';
        }
        if ($this->isColumnModified(MailboxPeer::UPDATED_AT)) {
    ...
    {
        if (isset($alreadyDumpedObjects['Mailbox'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['Mailbox'][$this->getPrimaryKey()] = true;
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(MailboxPeer::USERNAME)) $criteria->add(MailboxPeer::USERNAME, $this->username);
        if ($this->isColumnModified(MailboxPeer::PASSWORD)) $criteria->add(MailboxPeer::PASSWORD, $this->password);
        if ($this->isColumnModified(MailboxPeer::DATE_START)) $criteria->add(MailboxPeer::DATE_START, $this->date_start);
        if ($this->isColumnModified(MailboxPeer::DATE_END)) $criteria->add(MailboxPeer::DATE_END, $this->date_end);
        if ($this->isColumnModified(MailboxPeer::CREATED_AT)) $criteria->add(MailboxPeer::CREATED_AT, $this->created_at);
        if ($this->isColumnModified(MailboxPeer::UPDATED_AT)) $criteria->add(MailboxPeer::UPDATED_AT, $this->updated_at);
    ...
    public function getDomain(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aDomain === null && ($this->domain_id !== null) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                $this->aDomain->addMailboxen($this);
             */
        }
    ...
    {
        return (string) $this->exportTo(MailboxPeer::DEFAULT_STRING_FORMAT);
    }
