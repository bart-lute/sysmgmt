...
abstract class BaseNameserver extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'LF14\\SysMgmtBundle\\Model\\NameserverPeer';
    ...
    /**
     * Initializes internal state of BaseNameserver object.
     * @see        applyDefaults()
     */
     ...
     * @return Nameserver The current object (for fluent API support)
     */
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[] = NameserverPeer::ID;
        }
    ...
    public function setName($v)
    {
        ...
        if ($this->name !== $v) {
            $this->name = $v;
            $this->modifiedColumns[] = NameserverPeer::NAME;
        }
    ...
    public function setNotes($v)
    {
        ...
        if ($this->notes !== $v) {
            $this->notes = $v;
            $this->modifiedColumns[] = NameserverPeer::NOTES;
        }
    ...
    public function setCreatedAt($v)
    {
        ...
        if ($this->created_at !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = NameserverPeer::CREATED_AT;
            }
    ...
    public function setUpdatedAt($v)
    {
        ...
        if ($this->updated_at !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = NameserverPeer::UPDATED_AT;
            }
        } // if either are not null
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            return $startcol + 5; // 5 = NameserverPeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating Nameserver object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = NameserverPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = NameserverQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                NameserverPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(NameserverPeer::ID)) {
            $modifiedColumns[':p' . $index++]  = '`id`';
        }
        if ($this->isColumnModified(NameserverPeer::NAME)) {
            $modifiedColumns[':p' . $index++]  = '`name`';
        }
        if ($this->isColumnModified(NameserverPeer::NOTES)) {
            $modifiedColumns[':p' . $index++]  = '`notes`';
        }
        if ($this->isColumnModified(NameserverPeer::CREATED_AT)) {
            $modifiedColumns[':p' . $index++]  = '`created_at`';
        }
        if ($this->isColumnModified(NameserverPeer::UPDATED_AT)) {
            $modifiedColumns[':p' . $index++]  = '`updated_at`';
        }

        $sql = sprintf(
            'INSERT INTO `nameserver` (%s) VALUES (%s)',
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = NameserverPeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = NameserverPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['Nameserver'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['Nameserver'][$this->getPrimaryKey()] = true;
        $keys = NameserverPeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
            $keys[1] => $this->getName(),
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(NameserverPeer::ID)) $criteria->add(NameserverPeer::ID, $this->id);
        if ($this->isColumnModified(NameserverPeer::NAME)) $criteria->add(NameserverPeer::NAME, $this->name);
        if ($this->isColumnModified(NameserverPeer::NOTES)) $criteria->add(NameserverPeer::NOTES, $this->notes);
        if ($this->isColumnModified(NameserverPeer::CREATED_AT)) $criteria->add(NameserverPeer::CREATED_AT, $this->created_at);
        if ($this->isColumnModified(NameserverPeer::UPDATED_AT)) $criteria->add(NameserverPeer::UPDATED_AT, $this->updated_at);
    ...
    {
        $criteria = new Criteria(NameserverPeer::DATABASE_NAME);
        $criteria->add(NameserverPeer::ID, $this->id);
     ...
     * objects.
     *
     * @param object $copyObj An object of Nameserver (or compatible) type.
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return Nameserver Clone of current object.
     * @throws PropelException
     */
     ...
     * If this Nameserver is new, it will return
    ...
    public function setDomains(PropelCollection $domains, PropelPDO $con = null)
    {
        ...
        foreach ($domainsToDelete as $domainRemoved) {
            $domainRemoved->setNameserver(null);
        }
     ...
     * Otherwise if this Nameserver is new, it will return
     * an empty collection; or if this Nameserver has previously
     * been saved, it will retrieve related Domains from storage.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in Nameserver.
     *
     * @param Criteria $criteria optional Criteria object to narrow the query
     * @param PropelPDO $con optional connection object
     ...
     * @return PropelObjectCollection|Domain[] List of Domain objects
     */
    public function getDomainsJoinClient($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        $query = DomainQuery::create(null, $criteria);
    ...
    {
        return (string) $this->exportTo(NameserverPeer::DEFAULT_STRING_FORMAT);
    }
