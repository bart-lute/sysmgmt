...
use LF14\SysMgmtBundle\Model\map\ContactTableMap;
...
abstract class BaseContactPeer
{
    ...
    const OM_CLASS = 'LF14\\SysMgmtBundle\\Model\\Contact';

    /** the related TableMap class for this table */
    const TM_CLASS = 'LF14\\SysMgmtBundle\\Model\\map\\ContactTableMap';
    ...
    protected static $fieldNames = array (
        BasePeer::TYPE_PHPNAME => array ('Id', 'Name', 'Email', 'Address', 'Phone1', 'Phone2', 'CreatedAt', 'UpdatedAt', ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'name', 'email', 'address', 'phone1', 'phone2', 'createdAt', 'updatedAt', ),
        BasePeer::TYPE_COLNAME => array (ContactPeer::ID, ContactPeer::NAME, ContactPeer::EMAIL, ContactPeer::ADDRESS, ContactPeer::PHONE1, ContactPeer::PHONE2, ContactPeer::CREATED_AT, ContactPeer::UPDATED_AT, ),
        BasePeer::TYPE_RAW_COLNAME => array ('ID', 'NAME', 'EMAIL', 'ADDRESS', 'PHONE1', 'PHONE2', 'CREATED_AT', 'UPDATED_AT', ),
        BasePeer::TYPE_FIELDNAME => array ('id', 'name', 'email', 'address', 'phone1', 'phone2', 'created_at', 'updated_at', ),
    ...
    protected static $fieldKeys = array (
        BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'Name' => 1, 'Email' => 2, 'Address' => 3, 'Phone1' => 4, 'Phone2' => 5, 'CreatedAt' => 6, 'UpdatedAt' => 7, ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'name' => 1, 'email' => 2, 'address' => 3, 'phone1' => 4, 'phone2' => 5, 'createdAt' => 6, 'updatedAt' => 7, ),
        BasePeer::TYPE_COLNAME => array (ContactPeer::ID => 0, ContactPeer::NAME => 1, ContactPeer::EMAIL => 2, ContactPeer::ADDRESS => 3, ContactPeer::PHONE1 => 4, ContactPeer::PHONE2 => 5, ContactPeer::CREATED_AT => 6, ContactPeer::UPDATED_AT => 7, ),
        BasePeer::TYPE_RAW_COLNAME => array ('ID' => 0, 'NAME' => 1, 'EMAIL' => 2, 'ADDRESS' => 3, 'PHONE1' => 4, 'PHONE2' => 5, 'CREATED_AT' => 6, 'UPDATED_AT' => 7, ),
        BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'name' => 1, 'email' => 2, 'address' => 3, 'phone1' => 4, 'phone2' => 5, 'created_at' => 6, 'updated_at' => 7, ),
        BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, 5, 6, 7, )
    );
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(ContactPeer::ADDRESS);
            $criteria->addSelectColumn(ContactPeer::PHONE1);
            $criteria->addSelectColumn(ContactPeer::PHONE2);
    ...
    {
        // Invalidate objects in ClientContactPeer instance pool,
        // since one or more of them may be deleted by ON DELETE CASCADE/SETNULL rule.
        ClientContactPeer::clearInstancePool();
        // Invalidate objects in LocationPeer instance pool,
        // since one or more of them may be deleted by ON DELETE CASCADE/SETNULL rule.
    ...
    public static function buildTableMap()
    {
      ...
      if (!$dbMap->hasTable(BaseContactPeer::TABLE_NAME)) {
        $dbMap->addTableObject(new \LF14\SysMgmtBundle\Model\map\ContactTableMap());
      }
    }
    ...
    protected static function doOnDeleteCascade(Criteria $criteria, PropelPDO $con)
    {
        ...
        foreach ($objects as $obj) {
            ...
            // delete related ClientContact objects
            $criteria = new Criteria(ClientContactPeer::DATABASE_NAME);

            $criteria->add(ClientContactPeer::CONTACT_ID, $obj->getId());
            $affectedRows += ClientContactPeer::doDelete($criteria, $con);
        }
    ...
    protected static function doOnDeleteSetNull(Criteria $criteria, PropelPDO $con)
    {
        ...
        foreach ($objects as $obj) {
            ...
            // set fkey col in related Location rows to null
            $selectCriteria = new Criteria(ContactPeer::DATABASE_NAME);
            $updateValues = new Criteria(ContactPeer::DATABASE_NAME);
            $selectCriteria->add(LocationPeer::CONTACT_ID, $obj->getId());
            $updateValues->add(LocationPeer::CONTACT_ID, null);
