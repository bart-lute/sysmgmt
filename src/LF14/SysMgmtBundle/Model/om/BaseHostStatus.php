...
abstract class BaseHostStatus extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'LF14\\SysMgmtBundle\\Model\\HostStatusPeer';
    ...
    /**
     * Initializes internal state of BaseHostStatus object.
     * @see        applyDefaults()
     */
     ...
     * @return HostStatus The current object (for fluent API support)
     */
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[] = HostStatusPeer::ID;
        }
    ...
    public function setStatus($v)
    {
        ...
        if ($this->status !== $v) {
            $this->status = $v;
            $this->modifiedColumns[] = HostStatusPeer::STATUS;
        }
    ...
    public function setNotes($v)
    {
        ...
        if ($this->notes !== $v) {
            $this->notes = $v;
            $this->modifiedColumns[] = HostStatusPeer::NOTES;
        }
    ...
    public function setCreatedAt($v)
    {
        ...
        if ($this->created_at !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = HostStatusPeer::CREATED_AT;
            }
    ...
    public function setUpdatedAt($v)
    {
        ...
        if ($this->updated_at !== null || $dt !== null) {
            ...
            if ($currentDateAsString !== $newDateAsString) {
                ...
                $this->modifiedColumns[] = HostStatusPeer::UPDATED_AT;
            }
        } // if either are not null
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            return $startcol + 5; // 5 = HostStatusPeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating HostStatus object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = HostStatusPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = HostStatusQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                HostStatusPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(HostStatusPeer::ID)) {
            $modifiedColumns[':p' . $index++]  = '`id`';
        }
        if ($this->isColumnModified(HostStatusPeer::STATUS)) {
            $modifiedColumns[':p' . $index++]  = '`status`';
        }
        if ($this->isColumnModified(HostStatusPeer::NOTES)) {
            $modifiedColumns[':p' . $index++]  = '`notes`';
        }
        if ($this->isColumnModified(HostStatusPeer::CREATED_AT)) {
            $modifiedColumns[':p' . $index++]  = '`created_at`';
        }
        if ($this->isColumnModified(HostStatusPeer::UPDATED_AT)) {
            $modifiedColumns[':p' . $index++]  = '`updated_at`';
        }

        $sql = sprintf(
            'INSERT INTO `host_status` (%s) VALUES (%s)',
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = HostStatusPeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = HostStatusPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['HostStatus'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['HostStatus'][$this->getPrimaryKey()] = true;
        $keys = HostStatusPeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(HostStatusPeer::ID)) $criteria->add(HostStatusPeer::ID, $this->id);
        if ($this->isColumnModified(HostStatusPeer::STATUS)) $criteria->add(HostStatusPeer::STATUS, $this->status);
        if ($this->isColumnModified(HostStatusPeer::NOTES)) $criteria->add(HostStatusPeer::NOTES, $this->notes);
        if ($this->isColumnModified(HostStatusPeer::CREATED_AT)) $criteria->add(HostStatusPeer::CREATED_AT, $this->created_at);
        if ($this->isColumnModified(HostStatusPeer::UPDATED_AT)) $criteria->add(HostStatusPeer::UPDATED_AT, $this->updated_at);
    ...
    {
        $criteria = new Criteria(HostStatusPeer::DATABASE_NAME);
        $criteria->add(HostStatusPeer::ID, $this->id);
     ...
     * objects.
     *
     * @param object $copyObj An object of HostStatus (or compatible) type.
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return HostStatus Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return HostStatusPeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new HostStatusPeer();
        }
     ...
     * If this HostStatus is new, it will return
    ...
    public function setHosts(PropelCollection $hosts, PropelPDO $con = null)
    {
        ...
        foreach ($hostsToDelete as $hostRemoved) {
            $hostRemoved->setHostStatus(null);
        }
     ...
     * Otherwise if this HostStatus is new, it will return
     * an empty collection; or if this HostStatus has previously
     * been saved, it will retrieve related Hosts from storage.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in HostStatus.
     *
     * @param Criteria $criteria optional Criteria object to narrow the query
     * @param PropelPDO $con optional connection object
     ...
     * @return PropelObjectCollection|Host[] List of Host objects
     */
    public function getHostsJoinClient($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        $query = HostQuery::create(null, $criteria);
    ...
    {
        return (string) $this->exportTo(HostStatusPeer::DEFAULT_STRING_FORMAT);
    }
