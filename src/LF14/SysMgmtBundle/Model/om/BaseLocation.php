...
abstract class BaseLocation extends BaseObject implements Persistent
{
     ...
     * Peer class name
     */
    const PEER = 'LF14\\SysMgmtBundle\\Model\\LocationPeer';
    ...
    public function setNotes($v)
    {
        ...
        if ($this->notes !== $v) {
            $this->notes = $v;
            $this->modifiedColumns[] = LocationPeer::NOTES;
        }
    ...
    public function setContactId($v)
    {
        ...
        if ($this->contact_id !== $v) {
            $this->contact_id = $v;
            $this->modifiedColumns[] = LocationPeer::CONTACT_ID;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            return $startcol + 6; // 6 = LocationPeer::NUM_HYDRATE_COLUMNS.
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(LocationPeer::ID)) {
            $modifiedColumns[':p' . $index++]  = '`id`';
        }
        if ($this->isColumnModified(LocationPeer::NAME)) {
            $modifiedColumns[':p' . $index++]  = '`name`';
        }
        if ($this->isColumnModified(LocationPeer::NOTES)) {
            $modifiedColumns[':p' . $index++]  = '`notes`';
        }
        if ($this->isColumnModified(LocationPeer::CONTACT_ID)) {
            $modifiedColumns[':p' . $index++]  = '`contact_id`';
        }
        if ($this->isColumnModified(LocationPeer::CREATED_AT)) {
            $modifiedColumns[':p' . $index++]  = '`created_at`';
        }
        if ($this->isColumnModified(LocationPeer::UPDATED_AT)) {
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(LocationPeer::NOTES)) $criteria->add(LocationPeer::NOTES, $this->notes);
        if ($this->isColumnModified(LocationPeer::CONTACT_ID)) $criteria->add(LocationPeer::CONTACT_ID, $this->contact_id);
    ...
    public function getContact(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aContact === null && ($this->contact_id !== null) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                $this->aContact->addLocations($this);
             */
        }
