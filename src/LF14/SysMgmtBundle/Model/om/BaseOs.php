...
abstract class BaseOs extends BaseObject implements Persistent
{
     ...
     * Peer class name
     */
    const PEER = 'LF14\\SysMgmtBundle\\Model\\OsPeer';
    ...
    /**
     * The value for the distro field.
     * @var        string
     */
    protected $distro;
    ...
    /**
     * Initializes internal state of BaseOs object.
     * @see        applyDefaults()
     */
     ...
     * @return Os The current object (for fluent API support)
     */
    ...
    public function setPlatform($v)
    {
        ...
        if ($this->platform !== $v) {
            $this->platform = $v;
            $this->modifiedColumns[] = OsPeer::PLATFORM;
        }
    ...
    /**
     * Set the value of [distro] column.
     *
     * @param  string $v new value
     * @return Os The current object (for fluent API support)
     */
    public function setDistro($v)
    {
        if ($v !== null) {
            $v = (string) $v;
        }
        ...
        if ($this->distro !== $v) {
            $this->distro = $v;
            $this->modifiedColumns[] = OsPeer::DISTRO;
        }
    ...
    public function setVersion($v)
    {
        ...
        if ($this->version !== $v) {
            $this->version = $v;
            $this->modifiedColumns[] = OsPeer::VERSION;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->platform = ($row[$startcol + 1] !== null) ? (string) $row[$startcol + 1] : null;
            $this->distro = ($row[$startcol + 2] !== null) ? (string) $row[$startcol + 2] : null;
            ...
            return $startcol + 6; // 6 = OsPeer::NUM_HYDRATE_COLUMNS.
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(OsPeer::ID)) {
            $modifiedColumns[':p' . $index++]  = '`id`';
        }
        if ($this->isColumnModified(OsPeer::PLATFORM)) {
            $modifiedColumns[':p' . $index++]  = '`platform`';
        }
        if ($this->isColumnModified(OsPeer::DISTRO)) {
            $modifiedColumns[':p' . $index++]  = '`distro`';
        }
        if ($this->isColumnModified(OsPeer::VERSION)) {
            $modifiedColumns[':p' . $index++]  = '`version`';
        }
        if ($this->isColumnModified(OsPeer::CREATED_AT)) {
            $modifiedColumns[':p' . $index++]  = '`created_at`';
        }
        if ($this->isColumnModified(OsPeer::UPDATED_AT)) {
            $modifiedColumns[':p' . $index++]  = '`updated_at`';
        }

        $sql = sprintf(
            'INSERT INTO `os` (%s) VALUES (%s)',
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    ...
                    case '`platform`':
                        ...
                        break;
                    case '`distro`':
                        $stmt->bindValue($identifier, $this->distro, PDO::PARAM_STR);
                        break;
                    case '`version`':
    ...
    {
        if (isset($alreadyDumpedObjects['Os'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['Os'][$this->getPrimaryKey()] = true;
        $keys = OsPeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
            $keys[1] => $this->getPlatform(),
            $keys[2] => $this->getDistro(),
    ...
    public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[1], $arr)) $this->setPlatform($arr[$keys[1]]);
        if (array_key_exists($keys[2], $arr)) $this->setDistro($arr[$keys[2]]);
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(OsPeer::PLATFORM)) $criteria->add(OsPeer::PLATFORM, $this->platform);
        if ($this->isColumnModified(OsPeer::DISTRO)) $criteria->add(OsPeer::DISTRO, $this->distro);
        if ($this->isColumnModified(OsPeer::VERSION)) $criteria->add(OsPeer::VERSION, $this->version);
     ...
     * objects.
     *
     * @param object $copyObj An object of Os (or compatible) type.
    ...
    public function copyInto($copyObj, $deepCopy = false, $makeNew = true)
    {
        ...
        $copyObj->setDistro($this->getDistro());
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return Os Clone of current object.
     * @throws PropelException
     */
     ...
     * If this Os is new, it will return
     ...
     * Otherwise if this Os is new, it will return
     * an empty collection; or if this Os has previously
    ...
    {
        return (string) $this->exportTo(OsPeer::DEFAULT_STRING_FORMAT);
    }
