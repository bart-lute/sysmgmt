...
abstract class BaseLogin extends BaseObject implements Persistent
{
     ...
     * Peer class name
     */
    const PEER = 'LF14\\SysMgmtBundle\\Model\\LoginPeer';
    ...
    /**
     * The value for the login_type_id field.
     * @var        int
     */
    ...
    /**
     * Get the [login_type_id] column value.
     *
     * @return int
     */
    public function getLoginTypeId()
    {
    ...
    public function setHostId($v)
    {
        ...
        if ($this->host_id !== $v) {
            $this->host_id = $v;
            $this->modifiedColumns[] = LoginPeer::HOST_ID;
        }
    ...
    public function setPasswd($v)
    {
        ...
        if ($this->passwd !== $v) {
            $this->passwd = $v;
            $this->modifiedColumns[] = LoginPeer::PASSWD;
        }
    ...
    /**
     * Set the value of [login_type_id] column.
     *
     * @param  int $v new value
     * @return Login The current object (for fluent API support)
     */
    public function setLoginTypeId($v)
    {
        if ($v !== null && is_numeric($v)) {
            $v = (int) $v;
        }

        if ($this->login_type_id !== $v) {
            $this->login_type_id = $v;
            $this->modifiedColumns[] = LoginPeer::LOGIN_TYPE_ID;
        }

        if ($this->aLoginType !== null && $this->aLoginType->getId() !== $v) {
            $this->aLoginType = null;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->login_type_id = ($row[$startcol + 4] !== null) ? (int) $row[$startcol + 4] : null;
            ...
            return $startcol + 7; // 7 = LoginPeer::NUM_HYDRATE_COLUMNS.
    ...
    public function ensureConsistency()
    {
        ...
        if ($this->aLoginType !== null && $this->login_type_id !== $this->aLoginType->getId()) {
            $this->aLoginType = null;
        }
    } // ensureConsistency
    ...
    protected function doSave(PropelPDO $con)
    {
        ...
        if (!$this->alreadyInSave) {
            ...
            if ($this->aLoginType !== null) {
                if ($this->aLoginType->isModified() || $this->aLoginType->isNew()) {
                    $affectedRows += $this->aLoginType->save($con);
                }
                $this->setLoginType($this->aLoginType);
            }
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(LoginPeer::ID)) {
            $modifiedColumns[':p' . $index++]  = '`id`';
        }
        if ($this->isColumnModified(LoginPeer::HOST_ID)) {
            $modifiedColumns[':p' . $index++]  = '`host_id`';
        }
        if ($this->isColumnModified(LoginPeer::USERNAME)) {
            $modifiedColumns[':p' . $index++]  = '`username`';
        }
        if ($this->isColumnModified(LoginPeer::PASSWD)) {
            $modifiedColumns[':p' . $index++]  = '`passwd`';
        }
        if ($this->isColumnModified(LoginPeer::LOGIN_TYPE_ID)) {
            $modifiedColumns[':p' . $index++]  = '`login_type_id`';
        }
        if ($this->isColumnModified(LoginPeer::CREATED_AT)) {
            $modifiedColumns[':p' . $index++]  = '`created_at`';
        }
        if ($this->isColumnModified(LoginPeer::UPDATED_AT)) {
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    ...
                    case '`passwd`':
                        ...
                        break;
                    case '`login_type_id`':
                        $stmt->bindValue($identifier, $this->login_type_id, PDO::PARAM_INT);
                        break;
                    case '`created_at`':
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if ($this->aLoginType !== null) {
                if (!$this->aLoginType->validate($columns)) {
                    $failureMap = array_merge($failureMap, $this->aLoginType->getValidationFailures());
                }
            }
    ...
    {
        if (isset($alreadyDumpedObjects['Login'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['Login'][$this->getPrimaryKey()] = true;
        ...
        if ($includeForeignObjects) {
            ...
            if (null !== $this->aLoginType) {
                $result['LoginType'] = $this->aLoginType->toArray($keyType, $includeLazyLoadColumns,  $alreadyDumpedObjects, true);
            }
        }
    ...
    public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[4], $arr)) $this->setLoginTypeId($arr[$keys[4]]);
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(LoginPeer::HOST_ID)) $criteria->add(LoginPeer::HOST_ID, $this->host_id);
        if ($this->isColumnModified(LoginPeer::USERNAME)) $criteria->add(LoginPeer::USERNAME, $this->username);
        if ($this->isColumnModified(LoginPeer::PASSWD)) $criteria->add(LoginPeer::PASSWD, $this->passwd);
        if ($this->isColumnModified(LoginPeer::LOGIN_TYPE_ID)) $criteria->add(LoginPeer::LOGIN_TYPE_ID, $this->login_type_id);
    ...
    public function copyInto($copyObj, $deepCopy = false, $makeNew = true)
    {
        ...
        $copyObj->setLoginTypeId($this->getLoginTypeId());
    ...
    /**
     * Declares an association between this object and a LoginType object.
     *
     * @param                  LoginType $v
     * @return Login The current object (for fluent API support)
     * @throws PropelException
     */
    public function setLoginType(LoginType $v = null)
    {
        if ($v === null) {
            $this->setLoginTypeId(NULL);
        } else {
            $this->setLoginTypeId($v->getId());
        }

        $this->aLoginType = $v;

        // Add binding for other direction of this n:n relationship.
        // If this object has already been added to the LoginType object, it will not be re-added.
        if ($v !== null) {
            $v->addLogin($this);
        }
    ...
    /**
     * Get the associated LoginType object
     *
     * @param PropelPDO $con Optional Connection object.
     * @param $doQuery Executes a query to get the object if required
     * @return LoginType The associated LoginType object.
     * @throws PropelException
     */
    public function getLoginType(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aLoginType === null && ($this->login_type_id !== null) && $doQuery) {
            $this->aLoginType = LoginTypeQuery::create()->findPk($this->login_type_id, $con);
            /* The following can be used additionally to
                guarantee the related object contains a reference
                to this object.  This level of coupling may, however, be
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aLoginType->addLogins($this);
             */
        }

        return $this->aLoginType;
    }
    ...
    public function clearAllReferences($deep = false)
    {
        if ($deep && !$this->alreadyInClearAllReferencesDeep) {
            ...
            if ($this->aLoginType instanceof Persistent) {
              $this->aLoginType->clearAllReferences($deep);
            }
    ...
    {
        return (string) $this->exportTo(LoginPeer::DEFAULT_STRING_FORMAT);
    }
