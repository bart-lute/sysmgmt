...
abstract class BaseClientContact extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'LF14\\SysMgmtBundle\\Model\\ClientContactPeer';

    /**
     * The Peer class.
     * Instance provides a convenient way of calling static methods on a class
     * that calling code may not be able to identify.
     * @var        ClientContactPeer
     */
     ...
     * @return ClientContact The current object (for fluent API support)
     */
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[] = ClientContactPeer::ID;
        }
    ...
    public function setClientId($v)
    {
        ...
        if ($this->client_id !== $v) {
            $this->client_id = $v;
            $this->modifiedColumns[] = ClientContactPeer::CLIENT_ID;
        }
    ...
    public function setContactId($v)
    {
        ...
        if ($this->contact_id !== $v) {
            $this->contact_id = $v;
            $this->modifiedColumns[] = ClientContactPeer::CONTACT_ID;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            return $startcol + 3; // 3 = ClientContactPeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating ClientContact object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = ClientContactPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = ClientContactQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                ClientContactPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(ClientContactPeer::ID)) {
            $modifiedColumns[':p' . $index++]  = '`id`';
        }
        if ($this->isColumnModified(ClientContactPeer::CLIENT_ID)) {
            $modifiedColumns[':p' . $index++]  = '`client_id`';
        }
        if ($this->isColumnModified(ClientContactPeer::CONTACT_ID)) {
            $modifiedColumns[':p' . $index++]  = '`contact_id`';
        }

        $sql = sprintf(
            'INSERT INTO `client_contact` (%s) VALUES (%s)',
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = ClientContactPeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = ClientContactPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['ClientContact'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['ClientContact'][$this->getPrimaryKey()] = true;
        $keys = ClientContactPeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(ClientContactPeer::ID)) $criteria->add(ClientContactPeer::ID, $this->id);
        if ($this->isColumnModified(ClientContactPeer::CLIENT_ID)) $criteria->add(ClientContactPeer::CLIENT_ID, $this->client_id);
        if ($this->isColumnModified(ClientContactPeer::CONTACT_ID)) $criteria->add(ClientContactPeer::CONTACT_ID, $this->contact_id);
    ...
    {
        $criteria = new Criteria(ClientContactPeer::DATABASE_NAME);
        $criteria->add(ClientContactPeer::ID, $this->id);
     ...
     * objects.
     *
     * @param object $copyObj An object of ClientContact (or compatible) type.
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return ClientContact Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return ClientContactPeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new ClientContactPeer();
        }
    ...
    public function getClient(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aClient === null && ($this->client_id !== null) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                $this->aClient->addClientContacts($this);
             */
        }
    ...
    public function getContact(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aContact === null && ($this->contact_id !== null) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aContact->addClientContacts($this);
             */
        }
    ...
    {
        return (string) $this->exportTo(ClientContactPeer::DEFAULT_STRING_FORMAT);
    }
